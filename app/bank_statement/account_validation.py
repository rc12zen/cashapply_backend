...
Rule (generic structural — handles numeric accounts AND IBANs):
  ...
  - does not contain a known column-label word ("account", "iban", "sort code",
    "customer name", …)  (kills "Account Number 1" and friends that sneak a
    digit past the check above)
"""
